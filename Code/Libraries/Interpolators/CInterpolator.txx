...
template < class T, unsigned int VImageDimension >
void CInterpolator< T, VImageDimension >::Interpolate( const VectorImageType1D* imIn, const VectorImageType1D* pos, VectorImageType1D* imOut )
{
...
template < class T, unsigned int VImageDimension >
void CInterpolator< T, VImageDimension >::InterpolateNegativeVelocityPos( const VectorImageType1D* imIn, const VectorFieldType1D* v, T dt, VectorImageType1D* imOut )
{
  assert( m_NrOfPointsNegative > 0 );
  assert( m_NrOfPointsPositive > 0 );
...
template < class T, unsigned int VImageDimension >
void CInterpolator< T, VImageDimension >::Interpolate( const VectorImageType2D* imIn, const VectorImageType2D* pos, VectorImageType2D* imOut )
{
  assert( m_NrOfPointsNegative > 0 );
  assert( m_NrOfPointsPositive > 0 );
...
template < class T, unsigned int VImageDimension >
void CInterpolator< T, VImageDimension >::Interpolate( const VectorImageType3D* imIn, const VectorImageType3D* pos, VectorImageType3D* imOut )
{
  assert( m_NrOfPointsNegative > 0 );
  assert( m_NrOfPointsPositive > 0 );
...
template < class T, unsigned int VImageDimension >
void CInterpolator< T, VImageDimension >::InterpolateNegativeVelocityPos( const VectorImageType3D* imIn, const VectorFieldType3D* v, T dt, VectorImageType3D* imOut )
{
  assert( m_NrOfPointsNegative > 0 );
  assert( m_NrOfPointsPositive > 0 );
...
template < class T, unsigned int VImageDimension >
T CInterpolator< T, VImageDimension >::InterpolatePosGridCoordinates( const VectorImageType1D* imIn, T xPos, unsigned int d, int* ptrIndxVals, T* ptrVals )
{
...
template < class T, unsigned int VImageDimension >
T CInterpolator< T, VImageDimension >::InterpolatePosGridCoordinates( const VectorImageType2D* imIn, T xPos, T yPos, unsigned int d, int* ptrIndxXVals, int* ptrIndxYVals, T* ptrXVals, T* ptrYVals )
{
  const int m_NrOfPoints = m_NrOfPointsNegative + m_NrOfPointsPositive;
...
template < class T, unsigned int VImageDimension >
T CInterpolator< T, VImageDimension >::InterpolatePosGridCoordinates( const VectorImageType3D* imIn, T xPos, T yPos, T zPos, unsigned int d, int* ptrIndxXVals, int* ptrIndxYVals, int* ptrIndxZVals, T* ptrXVals, T* ptrYVals, T* ptrZVals )
{
  const int m_NrOfPoints = m_NrOfPointsNegative + m_NrOfPointsPositive;
...
template < class T, unsigned int VImageDimension >
T CInterpolator< T, VImageDimension >::Clamp( T dVal, T dLow, T dHigh )
{
  return std::max( std::min( dVal, dHigh), dLow );
}

template < class T, unsigned int VImageDimension >
void CInterpolator< T, VImageDimension >::GetIndices( T pos, int* ptrIndxVals, int minVal, int maxVal )
{
...
template < class T, unsigned int VImageDimension >
int CInterpolator< T, VImageDimension >::GetNegativeIndex( T pos, int iI, int minVal )
{
...
template < class T, unsigned int VImageDimension >
int CInterpolator< T, VImageDimension >::GetPositiveIndex( T pos, int iI, int maxVal )
{
  // for now just repeat the values at the boundaries (TODO: implement more flexible boundary condition)
  int ind = ceil( pos ) + iI;
...
template < class T, unsigned int VImageDimension >
T CInterpolator< T, VImageDimension >::GetS( T pos )
{
