...
private:
  ...
  CJSONConfiguration m_GivenAlgorithmJSONConfiguration;
  CJSONConfiguration m_GivenDataJSONConfiguration;
  bool m_GivenDataJSONConfigurationAutogeneratedFromSourceAndTargetImageFiles;
};
