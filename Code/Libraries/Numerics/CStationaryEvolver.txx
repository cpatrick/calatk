...
template <class T, unsigned int VImageDimension, class TSpace >
bool CStationaryEvolver< T, VImageDimension, TSpace >::SolveForward( VectorField* pV, VectorImage* pImIn, VectorImage* pImOut, VectorImage* pImTmp, T dT )
{
