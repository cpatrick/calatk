...
CONTINUE HERE: FIX KERNEL. NEEDS TO BE CONNECTED TO THE FOURIER DOMAIN KERNEL
FOURIER DOMAIN KERNEL SHOULD NOT DELETE THE DATA STRUCTURES OVER AND OVER AGAIN.
SHOULD ONLY INITIALIZE ONCE (ON DEMAND). TOO TIRED NOW.
